...
def prioritize_genes(gene_list, hf_token, n=20, llm_model="deepseek-ai/DeepSeek-R1-Distill-Qwen-14B", max_tokens=2000):
    """
    Retrieve the top N genes and their descriptions in the context of T cell biology using a Hugging Face model.
    ...
    Args:
        ...
        llm_model (str, optional): The model to be used for inference. Defaults to "deepseek-ai/DeepSeek-R1-Distill-Qwen-14B".
    ...
    Returns:
        tuple: A tuple containing:
            ...
            - top_20_genes_dict (dict): A dictionary containing the top N genes as keys and their descriptions as values.
            - summary_match (list): A list containing the summary of the cell functional profile.
    """
    # Convert to text
    ...
    messages = [
        {
            "role": "user",
            "content": f"Given the context of T cell biology, go through all of the genes below and return the top {n} genes in the format of gene - function and provide a sentence summary of the cell functional profile starting with ## summary: " + gene_list_character
        }
    ]
    ...
    try:
        ...
        pattern = r'\*\*(\w+)\*\* - ([^\n]+)'
        top_20_genes_with_descriptions = re.findall(pattern, full_reason_process)
    ...
    try:
        ...
        summary_match = re.findall(summary_pattern, full_reason_process, re.IGNORECASE)
    except Exception as e:
